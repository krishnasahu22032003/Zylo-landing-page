const Pricing = () => {
  return (
    <section id="pricing" className="bg-gradient-to-br from-[#0e0e11] to-[#1a1a1f] text-white py-32 px-6 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto relative z-10">
        {/* Starter Plan */}
        <div className="bg-[#15151c] p-10 rounded-3xl border border-gray-700 shadow-xl hover:shadow-2xl transition-transform duration-300 hover:scale-[1.04] backdrop-blur-md">
          ...
          <button className="mt-10 w-full py-3 cursor-pointer bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 rounded-full font-semibold text-white transition shadow-md">
            Get Started
          </button>
        </div>

        {/* Pro Plan */}
        <div className="bg-gradient-to-br from-blue-700 to-purple-700 p-10 rounded-3xl shadow-2xl transform scale-105 ring-2 ring-purple-500/20">
          ...
          <button className="mt-10 w-full py-3 cursor-pointer bg-white text-black font-semibold rounded-full hover:bg-gray-100 transition shadow-lg">
            Upgrade to Pro
          </button>
        </div>
        ...
        <div className="bg-[#15151c] p-10 rounded-3xl border border-gray-700 shadow-xl hover:shadow-2xl transition-transform duration-300 hover:scale-[1.04] backdrop-blur-md">
          ...
          <button className="mt-10 w-full py-3 cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-full font-semibold text-white transition shadow-md">
            Talk to Sales
          </button>
        </div>
      </div>
